...
fun generateAvatarBytes(
    ...
    val AVATAR_COLORS = listOf(
        "#FF6B6B".toColorInt(), "#FF9F43".toColorInt(), "#FECA57".toColorInt(),
        "#54A0FF".toColorInt(), "#5F27CD".toColorInt(), "#1DD1A1".toColorInt(),
        "#10AC84".toColorInt(), "#EE5A24".toColorInt(), "#0ABDE3".toColorInt(),
        "#A29BFE".toColorInt(), "#FD79A8".toColorInt(), "#00B894".toColorInt(),
        "#E17055".toColorInt(), "#6C5CE7".toColorInt(), "#FDCB6E".toColorInt(),
        "#00CEC9".toColorInt(),
    )
    ...
    canvas.drawRect(
        0f, 0f,
        pixelSize.toFloat(), pixelSize.toFloat(),
        paint
    )
